...
public class DoctorsLogin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextEmailMain = findViewById(R.id.emailMain);
        editTextPasswordMain = findViewById(R.id.passwordMain);
        ...
        databaseReference = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Users");
