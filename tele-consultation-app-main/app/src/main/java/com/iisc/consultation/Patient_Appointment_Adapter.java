        ...
        if(admin_payment_class.getPayment()==1 && admin_payment_class.getStatus()==0) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("title", "Teleconsultation Appointment");
                    holder.itemView.getContext().startActivity(i);

                }
            });
        }
        DatabaseReference reference = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Data");
