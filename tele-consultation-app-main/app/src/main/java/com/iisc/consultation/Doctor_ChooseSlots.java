...
//        email = email.replace(".",",");
        ...
        reference_doctor = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Data");
        reference_appt = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Appointments");
        reference_user = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Users");
        reference_booking = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Chosen_Slots");
        reference_token = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Tokens");
        reference_patient = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Patient_Chosen_Slots");
        reference_details = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Patient_Details");
        reference_payment = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Admin_Payment");


        TextInputLayout date_layout = findViewById(R.id.dateLayout);
        date_view = findViewById(R.id.date);
        TextInputLayout start_layout = findViewById(R.id.starttimelayout);
        start_view = findViewById(R.id.starttime);
        TextInputLayout end_layout = findViewById(R.id.endtimelayout);
        end_view = findViewById(R.id.endtime);
                ...
                if (snapshot.exists()) {
                    ...
                    ItemTouchHelper.SimpleCallback touchHelperCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
                        ...
                        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                            new AlertDialog.Builder(viewHolder.itemView.getContext()).setMessage("Do you want to Delete this Slot?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
