...
public class StepCounter_Service extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        reference_fitness = FirebaseDatabase.getInstance("https://consultapp-2ba50-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Fitness");
        ...
        if(step_sensor != null){
            ...
            pendingIntent = PendingIntent.getActivity(this, 0, inten, PendingIntent.FLAG_IMMUTABLE);
